...
const Cmd       = require('./CmdsRadar'); // Include CmdsRadar.js
...
const WS_DEVMGR_PORT = wsDevMgrPort.DEVMGR_RADAR; // WebSocket Server port
const WS_HAL_PORT    = wsHalPort.DEVMGR_RADAR; // WebSocket HAL port

const UDP_PORT       = 41443; // UDP port to listen on
