...
const Cmd       = require('./CmdsRFScan'); // Include CmdsRFScan.js
...
const WS_DEVMGR_PORT = wsDevMgrPort.DEVMGR_RFSCAN; // WebSocket Server port
const WS_HAL_PORT    = wsHalPort.DEVMGR_RFSCAN; // WebSocket HAL port

const UDP_PORT       = 41444; // UDP port to listen on
